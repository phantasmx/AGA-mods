**Good news**
not sure what happened, but AGA is now working with bepinex
this means we no longer need to modify game files for translation and assembly mods like uncensor
- no need to lock files anymore
- can run game as usual from dmm or shortcut
- no need to update mods when game updates - just drop and forget
